...
$id_user = $_SESSION['user_id'];
  ...
  $sql_select_campos="SELECT * FROM campos WHERE id_user= $id_user";
  $result_select = mysqli_query($conexao,$sql_select_campos);
        ...
        $cont=0;
            while($row = mysqli_fetch_array($result_select)) {
                if($cont==0) echo "<div class='row'>";
                    ...
                    <div class='card text-white bg-danger h-100' style=''>
                      <!--div class='card-header'>Campo</div-->
                      <div class='card-body'>
                        <h5 class='card-title'>Campo: ".$row['username']."</h5>
                        <p class='card-text'>Area: ".$row['distancia']."x".$row['lagura']."</p>
                      </div>
                      <div class='card-footer btn-group'>
                      <a class='text-white clearfix small z-1 btn' href='campo.php?campo=".$row['id']."'>Detalhes</a>
                        ...
                        <div class='dropdown-menu ' style=''>
                          <a class='dropdown-item' href='campo.php?campo=".$row['id']."'>Detalhes</a>
                          <a class='dropdown-item' href='#'>Editar</a>
                          <div class='dropdown-divider'></div>
                          <a class='dropdown-item' href='config/delete.php?tipo=campo&id=".$row['id']."'>Deletar</a>
                        </div>
                      </div>
                      </div>
                      </div>";
...
<div class="modal fade" id="add" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">ADD Campo</h5>
        <button class="close" type="button" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">×</span>
        </button>
      </div>
